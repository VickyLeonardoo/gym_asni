...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::get('memberships/{membership}/payment-proof', [PaymentController::class, 'edit'])->name('payments.edit');
    Route::put('memberships/{membership}/payment-proof', [PaymentController::class, 'update'])->name('payments.update');
