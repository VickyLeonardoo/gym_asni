...
<div>
    ...
    <textarea id="description" name="description" rows="4" class="mt-1 w-full rounded-md border-gray-300 text-sm">{{ old('description', $package->description) }}</textarea>
...
<div class="flex items-center gap-3">
    ...
    <a href="{{ route('packages.index') }}" class="rounded-md border px-4 py-2 text-sm font-semibold text-gray-700">Cancel</a>
</div>
