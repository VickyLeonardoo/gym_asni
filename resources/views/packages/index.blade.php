<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form method="GET" class="mb-4 flex flex-wrap gap-2">
            <input name="search" value="{{ request('search') }}" placeholder="Search package" class="rounded-md border-gray-300 text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($packages as $package)
                        <tr>
                            ...
                            <td>{{ number_format($package->duration_days) }} days</td>
                            ...
                            <td class="px-4">
                                <div class="flex justify-end gap-3">
                                    ...
                                    <form method="POST" action="{{ route('packages.destroy', $package) }}" onsubmit="return confirm('Delete this package?')">
                                        @csrf
                                        @method('DELETE')
                                        <button class="font-medium text-red-600">Delete</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
