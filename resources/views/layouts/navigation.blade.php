<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <span class="inline-flex h-9 w-9 items-center justify-center rounded bg-gray-900 text-white"><i class="bi bi-activity"></i></span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('members.index')" :active="request()->routeIs('members.*') || request()->routeIs('memberships.*')">
                        {{ __('Members') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('members.index')" :active="request()->routeIs('members.*') || request()->routeIs('memberships.*')">
                {{ __('Members') }}
            </x-responsive-nav-link>
